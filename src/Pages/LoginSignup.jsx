...
const LoginSignup = () => {
  return (
    <div className="loginsignup w-full h-auto bg-[#F2B8BD] py-[100px]">
      <div className="loginsignup-container w-[580px] h-auto bg-white m-auto py-[40px] px-[60px] rounded-3xl">
        ...
        <button className="w-[460px] h-[60px] text-white bg-[#ff4141] my-8 rounded-2xl text-[18px] font-[500] cursor-pointer">
          Continue
        </button>
