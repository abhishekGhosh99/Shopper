...
const Hero = () => {
  return (
    <div className="hero flex flex-row h-auto md:h-auto lg:h-[120vh] bg-gradient-to-b from-[#ddd6f3] to-[#faaca8] py-20 px-5">
      <div className="hero-left w-2/4 lg:flex-1 flex flex-col justify-center items-start lg:items-center gap-[30px] leading-[1] z-10">
        ...
        <div className="w-full lg:w-2/4 flex flex-col justify-center items-start text-wrap lg:text-nowrap text-[#171717] text-[35px] md:text-[65px] lg:text-[75px] font-[700] top-20">
          <p className="leading-[2.5rem] md:leading-[4rem] lg:leading-[5rem]">
      ...
      <div className="hero-right relative w-2/4 flex justify-end lg:justify-start items-end lg:items-center pl-8 lg:pl-16 left-10 top-10 md:left-[0px]">
        <img
